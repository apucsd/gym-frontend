...
import { FaDumbbell, FaUsers, FaAppleAlt, FaCheckCircle } from 'react-icons/fa';
        ...
        <div className="bg-white text-black min-h-screen py-16">
            ...
            <section className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 px-6 md:px-0">
                ...
                <motion.div
                    ...
                    transition={{ duration: 1 }}
                >
                    <FaDumbbell className="text-4xl text-primary mx-auto" />
                    ...
                    <motion.button
                        ...
                        className="mt-6 px-6 py-3 bg-primary text-black font-semibold rounded-lg hover:bg-yellow-600"
                    >
                        Learn More
                    </motion.button>
                </motion.div>
                ...
                >
                    <FaAppleAlt className="text-4xl text-primary mx-auto" />
            ...
            <div className="container mx-auto bg-white text-black py-16">
                ...
                {/* Call to Action */}
                <section className="container mx-auto text-center py-16 mt-16  rounded-lg">
                    <motion.h2
